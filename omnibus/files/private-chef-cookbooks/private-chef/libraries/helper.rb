...
class OmnibusHelper
  ...
  def elastic_search_major_version
    ...
    if node['private_chef']['opscode-erchef']['search_provider'] == 'elasticsearch'
      ...
      raise "Unsupported elasticsearch version of #{version}. There is current support for the major versions of 2, 5 and 6." if version != 7 && version != 6 && version != 5 && version != 2
      version
    else
